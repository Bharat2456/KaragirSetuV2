  ...
  void _continue() {
    ...
    if (key.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please enter your Groq API key to continue.')),
      );
      return;
    }
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const Text('Welcome to Karigar Setu', style: TextStyle(fontSize: 30, fontWeight: FontWeight.w800)),
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 12),
                    Expanded(child: Text('Prototype mode: your key is not written into the APK or committed to GitHub.')),
                  ],
                ),
              ),
            ),
            ...
            ElevatedButton.icon(
              ...
              label: const Text('Enter Karigar Setu'),
            ),
