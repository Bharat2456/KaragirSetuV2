          ...
          children: [
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                const SizedBox(height: 24),
                Row(children: [Expanded(child: ElevatedButton.icon(onPressed: () => _share(context), icon: const Icon(Icons.share_rounded), label: const LText('Share Page'))), const SizedBox(width: 10), IconButton.filled(onPressed: () => _save(context), icon: const Icon(Icons.bookmark_add_outlined), tooltip: L10n.t('Save'))]),
                const SizedBox(height: 14),
