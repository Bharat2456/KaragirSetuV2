  ...
  Widget build(BuildContext context) => Scaffold(
    body: SafeArea(child: Center(child: SingleChildScrollView(padding: const EdgeInsets.all(24), child: ConstrainedBox(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        ...
        InputDecorator(decoration:InputDecoration(labelText:L10n.t('Language')),child:DropdownButtonHideUnderline(child:DropdownButton<String>(value:AppLocale.code,isExpanded:true,items:AppLanguages.supported.map((l)=>DropdownMenuItem(value:l.code,child:LText('${l.nativeName} (${l.name})'))).toList(),onChanged:(v){if(v!=null){AppLocale.set(v);setState((){});}}))),
